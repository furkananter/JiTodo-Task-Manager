...
const SingleTodo: React.FC<Props> = ({ todo, setTodos, todos }: Props) => {
  ...
  //TODO: ENG: This function is used to edit the todo.
  ...
  // useRef Hook'u ile Edit Butonuna basıldığında direkt focus almasını sağlayacağız.
      ...
      <div className="flex items-center justify-center">
        {/*
          //------------------------------------------------------------------------------------
            ...
            - bunu şu an kullanmama gerek kalmadı.
          //--------------------------------------------------------------------------------------
        */}
        <button
          type="button"
